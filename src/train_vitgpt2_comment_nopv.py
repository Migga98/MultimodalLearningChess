...
if __name__ == "__main__":
    experiment_name = 'ViTGPT_Chess_noPV_DGX_V1'
    batch_size = 32
    epochs = 8
    learning_rate = 2e-5
    warmup_steps = 1e2
    ...
    os.makedirs('./data/train_stats/ViTGPT2_noPV', exist_ok=True)

    df_stats.to_csv(os.path.join("./data/train_stats/ViTGPT2_noPV", experiment_name + ".csv"))
    ...
    savedir = os.path.join("./data/train_stats/ViTGPT2_noPV", name)
    plt.savefig(savedir)
    # plt.show()
